...
_XFAIL_BY_NODE = {
    ...
    "test_overrides_gtk.py::TestTextBuffer::test_insert_text_signal_location_modification": "signal TextIter passed by value, not by reference — location.assign() has no effect",
    ...
    "test_properties.py::TestPropertyObject::test_strings": "GStrv GValue conversion not implemented; requires C-level fix in Value.c",
