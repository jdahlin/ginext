...
_XFAIL_BY_NODE = {
    ...
    "test_properties.py::TestPropertyObject::test_boxed": "GLib.Regex GBoxed property returns str instead of GLib.Regex wrapper",
    ...
    "test_repository.py::Test::test_arg_info": "GI info objects missing pygobject compat methods (get_arguments etc.)",
    "test_repository.py::Test::test_async_method_finish_func": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_base_info": "GI info objects missing pygobject compat methods (get_name_unescaped, get_container)",
    "test_repository.py::Test::test_callable_can_throw_gerror": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_callable_info": "GI info objects missing pygobject compat methods (get_arguments)",
    "test_repository.py::Test::test_callable_inheritance": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_enum_info": "GI info objects missing pygobject compat methods (get_values)",
    "test_repository.py::Test::test_enums": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_field_info": "GI info objects missing pygobject compat methods (get_fields)",
    "test_repository.py::Test::test_fundamental_object_info": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_interface_info": "GI info objects missing pygobject compat methods (get_properties)",
    "test_repository.py::Test::test_introspected_argument_info": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_method_finish_func": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_method_info": "GI info objects missing pygobject compat methods (get_methods)",
    "test_repository.py::Test::test_notify_signal_info_with_obj": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_object_constructor": "GI info objects missing pygobject compat methods (get_constructors)",
    "test_repository.py::Test::test_object_info": "GI info objects missing pygobject compat methods (get_properties)",
    "test_repository.py::Test::test_property_info": "GI info objects missing pygobject compat methods (get_properties)",
    "test_repository.py::Test::test_registered_type_info": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_signal_info": "GI info objects missing pygobject compat methods (get_signals)",
    "test_repository.py::Test::test_struct_info": "GI info objects missing pygobject compat methods (get_fields)",
    "test_repository.py::Test::test_type_info": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_union_info": "GI info objects missing pygobject compat methods",
    "test_repository.py::Test::test_vfunc_info": "GI info objects missing pygobject compat methods",
    ...
    "test_subprocess.py::TestProcess::test_child_watch_no_data": "spawn_async() positional argv form not implemented",
    "test_subprocess.py::TestProcess::test_child_watch_with_data": "spawn_async() positional argv form not implemented",
    "test_subprocess.py::TestProcess::test_spawn_async_envp": "spawn_async() standard_output/_input kwargs not implemented",
    "test_subprocess.py::TestProcess::test_spawn_async_fds": "spawn_async() standard_output/_input kwargs not implemented",
    "test_subprocess.py::test_spawn_async_fds_with_child_setup": "spawn_async() user_data kwarg not implemented",
