...
class TestVFuncsWithObjectArg(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        reason="crashes under ginext pygobject compatibility", run=False, strict=False
    )
...
class TestVFuncsWithFloatingArg(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        reason="floating object transfer compatibility is not implemented yet",
        strict=False,
    )
