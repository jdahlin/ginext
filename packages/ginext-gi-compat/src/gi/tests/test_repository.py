...
from gi.module import RepositoryInfo
from gi.repository import GObject


def _require(info: RepositoryInfo | None) -> RepositoryInfo:
...
class Test(unittest.TestCase):
    ...
    def test_arg_info(self):
        func_info = _require(
            repo.find_by_name("GIMarshallingTests", "array_fixed_out_struct")
        )
    ...
    def test_base_info(self):
        info = _require(repo.find_by_name("GIMarshallingTests", "Object"))
        ...
        info2 = _require(repo.find_by_name("GIMarshallingTests", "Object"))
    ...
    def test_fundamental_object_info(self):
        ...
        info = _require(repo.find_by_name("Regress", "TestFundamentalObject"))
    ...
    def test_interface_info(self):
        info = _require(repo.find_by_name("GIMarshallingTests", "Interface"))
        self.assertTrue(isinstance(info.get_methods(), abc.Iterable))
        self.assertTrue(isinstance(info.get_vfuncs(), abc.Iterable))
        self.assertTrue(isinstance(info.get_constants(), abc.Iterable))
    ...
    def test_struct_info(self):
        info = _require(repo.find_by_name("GIMarshallingTests", "InterfaceIface"))
        ...
        info = _require(repo.find_by_name("GIMarshallingTests", "SimpleStruct"))
    ...
    def test_enum_info(self):
        info = _require(repo.find_by_name("GIMarshallingTests", "Enum"))
    ...
    def test_union_info(self):
        info = _require(repo.find_by_name("GIMarshallingTests", "Union"))
    ...
    def test_property_info(self):
        info = _require(repo.find_by_name("GIMarshallingTests", "PropertiesObject"))
    ...
    def test_signal_info(self):
        repo.require("Regress")
        info = _require(repo.find_by_name("Regress", "TestObj"))
    ...
    def test_introspected_argument_info(self):
        try:
            ...
            self.skipTest(f"introspected GIRepository namespace unavailable: {exc}")
