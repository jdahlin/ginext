...
class TestGDBusClient(unittest.TestCase):
    ...
    def test_native_calls_async(self):
        ...
        data: dict[str, Any] = {"main_loop": main_loop}
    ...
    @pytest.mark.xfail(
        reason="GDBus dynamic proxy sync method compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="GDBus dynamic proxy no-argument method compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="GDBus dynamic proxy sync error compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="GDBus dynamic proxy method compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="GDBus dynamic proxy async result-error compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="GDBus dynamic proxy async error-handler compatibility is incomplete",
        strict=False,
    )
...
class TestDBusConnection:
    @unittest.skipUnless(has_dbus, "no dbus running")
    @pytest.mark.xfail(
        reason="GDBus object registration closure compatibility is incomplete",
        strict=False,
    )
    def test_register_object(self):
        ...
        for kwargs in (
            ...
            reg_id = bus.register_object(**cast(Any, kwargs))
            bus.unregister_object(reg_id)

    @unittest.skipUnless(has_dbus, "no dbus running")
    @pytest.mark.xfail(
        reason="hangs in GDBus invocation ref-count server loop",
        run=False,
        strict=False,
    )
