...
docstring_compat_xfail = pytest.mark.xfail(
    reason="PyGObject callable docstring compatibility is incomplete",
    strict=False,
)
...
class Test(unittest.TestCase):
    ...
    def test_shared_array_length_with_prior_out_arg(self):
        ...
        assert Gtk.ListStore.insert_with_valuesv.__doc__ is not None
        self.assertRegex(
