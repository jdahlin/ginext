...
GLibUnix = None
try:
    from gi.repository import GLibUnix  # type: ignore[no-redef]
except ImportError:
    pass
...
class TestGLib(unittest.TestCase):
    ...
    def test_xdg_dirs(self):
        ...
        self.assertEqual(
            str(w[0].message),
            "GLib.USER_DIRECTORY_MUSIC is deprecated; use "
            "GLib.UserDirectory.DIRECTORY_MUSIC instead",
        )
...
https://my.org/q?x=1&y=2
    ...
    def test_glib_version(self):
        ...
        self.assertEqual(
            str(w[0].message),
            "GLib.glib_version is deprecated; use "
            "(GLib.MAJOR_VERSION, GLib.MINOR_VERSION, GLib.MICRO_VERSION) instead",
        )
    ...
    def test_pyglib_version(self):
        ...
        self.assertEqual(
            str(w[0].message),
            "GLib.pyglib_version is deprecated; use gi.version_info instead",
        )
