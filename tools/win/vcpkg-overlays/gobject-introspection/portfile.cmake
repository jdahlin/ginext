...
# On Windows g-ir-scanner hard-errors when a library can't be resolved to a
# shared library (a DLL). Static, data-only import libs -- e.g. GTK's d3d12
# backend pulls dxguid / DirectX-Headers / DirectX-Guids -- have no DLL, so
# scanning Gdk-4.0 aborts with "can't resolve libraries to shared libraries".
# Those libs carry no introspectable symbols and need not appear in the
# typelib's shlib list, so downgrade the hard failure to a warning + skip.
vcpkg_replace_string(
    "${SOURCE_PATH}/giscanner/ccompiler.py"
    ...
    [[        if len(not_resolved) > 0:
            print(
                "g-ir-scanner: warning: skipping static/unresolved libraries: " +
                ", ".join(not_resolved))]]
)
