...
class TestEverything(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        reason="unichar invalid input exception compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="PyGObject object constructor alias compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="PyGObject argument error message compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="Python type to GType marshalling compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="GType array marshalling compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="non-UTF-8 string array error propagation is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="GType container marshalling compatibility is incomplete",
        strict=False,
    )
...
class TestCallbacks(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        reason="async callback lifetime compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="hangs under ginext pygobject compatibility", run=False, strict=False
    )
    ...
    @pytest.mark.xfail(
        reason="callback destroy-notify lifetime compatibility is incomplete",
        strict=False,
    )
    ...
    @pytest.mark.xfail(
        reason="callback destroy-notify no-user-data compatibility is incomplete",
        strict=False,
    )
...
class TestClosures(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        reason="closure GVariant marshalling compatibility is incomplete",
        strict=False,
    )
    def test_variant(self):
    ...
    @pytest.mark.xfail(
        reason="closure GVariant error compatibility is incomplete",
        strict=False,
    )
...
class TestBoxed(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        reason="deprecated positional boxed constructor compatibility is incomplete",
        strict=False,
    )
    ...
    def test_glist_boxed_none_return(self):
        # The C fixture stores the first non-empty result in a static GList,
        # so another test in this worker may already have initialized it.
        existing = Everything.test_glist_boxed_none_return(0)
        expected_len = len(existing) or 2
        del existing

        list_ = Everything.test_glist_boxed_none_return(2)
        assert len(list_) == expected_len
        assert list_[0].refcount == 2
        assert list_[1].refcount == 2

    @pytest.mark.xfail(
        reason="boxed full-transfer container ownership compatibility is incomplete",
        strict=False,
    )
...
class TestTortureProfile(unittest.TestCase):
    @pytest.mark.skipif(
        ...
        reason="too slow for the debug Python test watchdog",
    )
...
class TestAdvancedInterfaces(unittest.TestCase):
    ...
    @pytest.mark.xfail(
        reason="skip-return-value no-out compatibility is incomplete",
        strict=False,
    )
