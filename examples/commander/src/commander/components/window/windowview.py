...
class CommanderWindow(Adw.ApplicationWindow, type_name="GoiCommanderWindow"):
    ...
    def __init__(self, application: CommanderApp) -> None:
        ...
        self.left.selection.notify("selected").connect(
            lambda selection, pspec: self._on_selection_changed(selection, pspec, self.left)
        )
        self.right.selection.notify("selected").connect(
            lambda selection, pspec: self._on_selection_changed(selection, pspec, self.right)
        )
