...
_XFAIL_BY_NODE = {
    ...
    "test_subprocess.py::TestProcess::test_deprecated_child_watch_data_priority": "GLib._child_watch_add_get_args helper not implemented",
    "test_subprocess.py::TestProcess::test_deprecated_child_watch_data_priority_kwargs": "GLib._child_watch_add_get_args helper not implemented",
    "test_subprocess.py::TestProcess::test_deprecated_child_watch_no_data": "GLib._child_watch_add_get_args helper not implemented",
    ...
    "test_subprocess.py::test_child_watch_add_get_args_various": "GLib._child_watch_add_get_args helper not implemented",
